...
GPU = 0
MODEL_PATH = "./t5-v1_1-xxl"
CONFIG_PATH = "./configs/hrdt.yaml"
SAVE_DIR = "./embeddings"

# Modify this to your task name and instruction
TASK_NAME = "water_pouring"
INSTRUCTION = "The left robotic arm pick up the water bottle and pour water into the cup, then the right robotic arm pick up the cup and place it on the coaster."
