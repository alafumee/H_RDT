...
export OUTPUT_DIR="./checkpoints/pretrain_eef_rotmat_vistest"
...
accelerate launch --num_processes=1 --main_process_port 29500 main.py \
    ...
    --config_path="configs/hrdt_pretrain_eef_rotmat.yaml" \
    --output_dir=$OUTPUT_DIR \
    --train_batch_size=32 \
    --sample_batch_size=1 \
    --max_train_steps=180010 \
    ...
    --allow_tf32 \
    --dataset_name="egodex" \
    --action_mode="eef_rotmat" \
    --resume_from_checkpoint="checkpoint-180000" \
